...
from ..utils import action_callback_push_away_adversary as action_callback
    ...
    def reset_world(self, world, task):
        ...
        for i, agent in enumerate(world.agents):
            ...
            if not agent.adversary:
                ...
                # 复制landmark的位置
                agent.state.p_pos = world.landmarks[i-self.num_agents].state.p_pos.copy()
